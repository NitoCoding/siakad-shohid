      ...
      <tr>
        ...
        <td><div align="center">
          <?
		         ...
		         $tampi1=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP005' and thn_ajaran='$thaj' and semester='$sem' ");
      ...
      <tr>
        ...
        <td><div align="center">
            <? 
			  ...
			  $tampi2=mysqli_query($koneksi, "SELECT * FROM mata_pelajaran WHERE kd_mp='$kmps' ");
              $tpk3=mysqli_fetch_assoc($tampi2);
			  if($ct['kelas_st']=='VIIA' or $ct['kelas_st']=='VIIB' or $ct['kelas_st']=='VIIC' or $ct['kelas_st']=='VIID') { echo $tpk3['kkm']; $t=$tpk3['kkm']; }
			  if($ct['kelas_st']=='VIIIA' or $ct['kelas_st']=='VIIIB' or $ct['kelas_st']=='VIIIC'  or $ct['kelas_st']=='VIIID') { echo $tpk3['kkm2']; $t=$tpk3['kkm2']; }
			  if($ct['kelas_st']=='IXA' or $ct['kelas_st']=='IXB' or $ct['kelas_st']=='IXC') { echo $tpk3['kkm3'];   $t=$tpk3['kkm2']; }
        ...
        <td><div align="center">
	      ...
	      $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='$kmps' and thn_ajaran='$thaj' and semester='$sem' ");
          $tpk=mysqli_fetch_assoc($tampi);
		  $j10=$tpk['raport'];
		  echo $tpk['raport']; ?>
        </div></td>
