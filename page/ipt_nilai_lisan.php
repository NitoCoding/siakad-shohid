...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><select name="menu1" onchange="MM_jumpMenu('parent',this,0)">
      ...
      <?
	    ...
	    ?>
      <option value="home.php?home=nilai&amp;dpn_nl4=n4&amp;klsk=<? echo "$tp3[kd_kls]&klsk2=$tp3[kelas]"; ?>" <? if($klsk2=="$tp3[kelas]"){ echo"selected='selected'"; } ?>><? echo $tp3['kelas']; ?></option>
      <? } ?>
    </select>
      ...
      <select name="select2" onchange="MM_jumpMenu('parent',this,0)">
                <option value="home.php?home=nilai&amp;dpn_nl4=n4<? echo"&klsk=$klsk&nisk=$nisk"; ?>">-</option>
                <?
	      $tampi5=mysqli_query($koneksi, "SELECT kd_mp,nama_mp FROM mata_pelajaran WHERE ket='ML' or ket='PR'");
          while($tp5=mysqli_fetch_assoc($tampi5)){
	    ?>  
                <option value="home.php?home=nilai&dpn_nl4=n4<? echo"&klsk=$klsk&mpl=$tp5[kd_mp]&klsk2=$klsk2"; ?>" <? if($mpl=="$tp5[kd_mp]"){ echo"selected='selected'"; } ?>><? echo $tp5['nama_mp']; ?></option>
                <? } ?>
    </select></td>
  </tr>
  <?  
    ...
    <td colspan="3" valign="top"><?
	  ...
	  ?>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bordercolor="#B3CF70">
          ...
          <tr>
            <td colspan="3" bgcolor="#B3CF70" >
              <table width="700" height="62" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="27" bgcolor="#666600"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nis</font></div></td>
                  <td bgcolor="#663333"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Nama 
                  Santri</font></div></td>
                  <td bgcolor="#666600"><div align="center" class="style13">N i l a i  </div></td>
                  <td bgcolor="#663333"><div align="center" class="style13">Action</div></td>
                </tr>
		 ...
		 if($mpl!="" and $klsk!=""){
	$ntgs=mysqli_query($koneksi, "SELECT * FROM  tb_nilai_lisan WHERE nis_santri=$tp[nis] and kd_mp='$mpl' and semester='$sem' and thn_ajaran='$thaj' ");
 ...
 <td width="11%"><div align="center">
   <input <? if($rk==0){ echo"name='rekam'"; }else{ echo"name='ubah'"; } ?> type="submit" value="S A V E" />
 </div></td>
