...
http://www.shohwatulisad.sch.id e-mail : info@shohwatulisad.sch.id </span></div></td>
  ...
  <tr>
      <?
		  ...
		  $tmpkls2=mysqli_query($koneksi, "SELECT * FROM master_kelas WHERE kelas='$ct[kelas_st]' ");
  ...
  <tr>
    <td height="752"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td><div align="center">
          <? 
		   $tampi=mysqli_query($koneksi, "SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD003' and kd='3'");
          $tpk=mysqli_fetch_assoc($tampi);
		  $j3=$tpk['nir'];
		  if($j3 >=1){ $tn3=1; }
      ...
      <tr>
        <td><div align="center">
          <? 
		   ...
		   $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MD020' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$ctk2[kd_kls]'");
          $tpk=mysqli_fetch_assoc($tampi);
      ...
      <tr>
        <td height="21"><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MD022' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$ctk2[kd_kls]'");
          $tpk=mysqli_fetch_assoc($tampi);
      ...
      <tr>
        <td height="27"><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MD015' and thn_ajaran='$thaj' and semester='$sem' and kd_kelas='$ctk2[kd_kls]'");
          $tpk=mysqli_fetch_assoc($tampi);
      ...
      <tr>
        ...
        <td><div align="center">
          <div align="center">
            <? 
			  $tampi2=mysqli_query($koneksi, "SELECT * FROM mata_pelajaran WHERE kd_mp='MP022' ");
              $tpk3=mysqli_fetch_assoc($tampi2);
			  if($j29 >=1){
			if($ct['kelas_st']=='VIIA' or $ct['kelas_st']=='VIIB' or $ct['kelas_st']=='VIIC' or $ct['kelas_st']=='XA' or $ct['kelas_st']=='XB' or $ct['kelas_st']=='XC')  { echo $ctk3['kkm']; }
		if($ct['kelas_st']=='VIIIA' or $ct['kelas_st']=='VIIIB' or $ct['kelas_st']=='VIIIC' or $ct['kelas_st']=='XIA' or $ct['kelas_st']=='XIB' or $ct['kelas_st']=='XIC')  { echo $ctk3['kkm2']; }
      ...
      <tr>
        ...
        <td><div align="center">
          <div align="center">
            <? 
			  $tampi2=mysqli_query($koneksi, "SELECT * FROM mata_pelajaran WHERE kd_mp='MP020' ");
              $tpk3=mysqli_fetch_assoc($tampi2);
			  if($j30 >=1){
			if($ct['kelas_st']=='VIIA' or $ct['kelas_st']=='VIIB' or $ct['kelas_st']=='VIIC' or $ct['kelas_st']=='XA' or $ct['kelas_st']=='XB' or $ct['kelas_st']=='XC')  { echo $ctk3['kkm']; }
		if($ct['kelas_st']=='VIIIA' or $ct['kelas_st']=='VIIIB' or $ct['kelas_st']=='VIIIC' or $ct['kelas_st']=='XIA' or $ct['kelas_st']=='XIB' or $ct['kelas_st']=='XIC')  { echo $ctk3['kkm2']; }
      ...
      <tr>
        <td><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_raport_k13 WHERE id_santri='$ct[id_santri]' and tahun_ajaran='$thaj' and semester='$sem' and kd_mapel='MD024' and kd='3'");
          $tpk=mysqli_fetch_assoc($tampi);
		  $j31=$tpk['nir'];
		  if($j31 >=1){ $tn31=1; }
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <?
	    $tampil=mysqli_query($koneksi, "SELECT * FROM tb_ttd WHERE ket='a' ");
