    ...
    <td height="752"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td><div align="center">
          ...
          $tpk2=mysqli_fetch_assoc($tampi);  $nrfiq=$tpk2['raport'];   
		  $nl_pai=ceil(($nrtrk+$nrfiq)/2);
		...
		if($ct['kelas_st']=='VIIA' or $ct['kelas_st']=='VIIB' or $ct['kelas_st']=='VIIC' or $ct['kelas_st']=='X')  { echo $ctk3['kkm']; }
		if($ct['kelas_st']=='VIIIA' or $ct['kelas_st']=='VIIIB' or $ct['kelas_st']=='VIIIC' or $ct['kelas_st']=='XI')  { echo $ctk3['kkm2']; }
      ...
      <tr>
        ...
        <td><div align="center">
          <? 
			  ...
			  if($j2 >=1){
			  if($ct['kelas_st']=='VIIA' or $ct['kelas_st']=='VIIB' or $ct['kelas_st']=='VIIC' or $ct['kelas_st']=='X') { echo $tpk3['kkm']; }
			  if($ct['kelas_st']=='VIIIA' or $ct['kelas_st']=='VIIIB' or $ct['kelas_st']=='VIIIC' or $ct['kelas_st']=='XI') { echo $tpk3['kkm2']; }
      ...
      <tr>
        ...
        <td><div align="center">
		 ...
		 $pnl=$tn+$tn1+$tn2+$tn3+$tn4+$tn5+$tn6+$tn7+$tn8+$tn9+$tn10+$tn11+$tn12+$tn13+$tn14+$tn15+$tn16+$tn17+$tn18+$tn19+$tn20+
		      $tn21+$tn22+$tn23+$tn24+$tn25+$tn26+$tn27;	  
