    ...
    <td height="667"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td><div align="center">
          ...
          $tpk1=mysqli_fetch_assoc($tampi); $ntk1=$tpk1['uts']; $nt1=$tpk1['nt1']; $nt2=$tpk1['nt2']; $nt3=$tpk1['nt3']; $nu1=$tpk1['uh1']; $nu2=$tpk1['uh2']; $nu3=$tpk1['uh3'];
		  
		  $tampi2=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP006' and thn_ajaran='$thaj' and semester='$sem' ");
         $tpk12=mysqli_fetch_assoc($tampi2); $ntk2=$tpk12['uts']; $nn1=$tpk12['nt1']; $nn2=$tpk12['nt2']; $nn3=$tpk12['nt3']; $nl1=$tpk12['uh1']; $nl2=$tpk12['uh2']; $nl3=$tpk12['uh3'];
		  $sikap=$tpk12['sikap'];
      ...
      <tr>
        <td><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP016' and thn_ajaran='$thaj' and semester='$sem' ");
          $tpk=mysqli_fetch_assoc($tampi);  
		  echo $tpk['sikap'];
      ...
      <tr>
        <td height="21"><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='MP018' and thn_ajaran='$thaj' and semester='$sem' ");
          $tpk=mysqli_fetch_assoc($tampi);  
		  echo $tpk['sikap'];
      ...
      <tr>
        <td><div align="center">
		  ...
		  $tampi=mysqli_query($koneksi, "SELECT * FROM tb_nilai WHERE nis='$ct[nis]' and kd_mp='ML014' and thn_ajaran='$thaj' and semester='$sem' ");
          $tpk=mysqli_fetch_assoc($tampi);  
		  echo $tpk['sikap'];
