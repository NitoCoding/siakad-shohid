...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="23" colspan="10">Rekap Penilaian Pegawai <?  if($tkt=="KSP") {echo "Kesantrian Putra";} if($tkt=="KSI") {echo "Kesantrian Putri";} ?> Bulan <? if($qbln=="1"){ echo "Januari"; }
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><div align="center"><strong>Tepat Waktu Meyelesaikan Tugas </strong></div></td>
    <td bgcolor="#CCCCCC"><div align="center"><strong>Tanggung Jawab &amp; Loyalitas </strong></div></td>
    <td bgcolor="#CCCCCC"><div align="center"><strong>Kreatif</strong></div></td>
    <td bgcolor="#CCCCCC"><div align="center"><strong>Komunikasi Yang Baik </strong></div></td>
    <td bgcolor="#CCCCCC"><div align="center"><strong>Kepatuhan Terhadap intruksi </strong></div></td>
    <td bgcolor="#CCCCCC"><div align="center"><strong>Kemampuan mencapai target</strong></div></td>
  ...
  <? 
  $no=1;
  $tampi3=mysqli_query($koneksi, "SELECT * FROM guru_pegawai WHERE unit='$tkt' ");
