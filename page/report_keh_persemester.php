  ...
  ?>
      <tr>
        ...
        <td><div align="center">
            <?
   $skt=0;
   $tdth=mysqli_query($koneksi, "SELECT * FROM tb_nilai_ext WHERE thn_ajar='$thaj' and semester='$sem' and kd_santri='$tp[nis]' and kelas='$klsk' ");
   while($tdh=mysqli_fetch_assoc($tdth)){
   $skt=$tdh['izin']+$skt;
   }
   echo $skt;
