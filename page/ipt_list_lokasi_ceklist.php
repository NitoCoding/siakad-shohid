    ...
    <tr>
      ...
      <td><div align="left">
        <select name="lokasi_lst">
          <option>-</option>
          <?
	      $tampi3=mysqli_query($koneksi, "SELECT * FROM tb_lokasi_ceklist ");
    ...
    <tr>
      ...
      <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
		  ...
		  <?  $no=1;
		  $tampil=mysqli_query($koneksi, "SELECT * FROM tb_list_lokasi_ceklist ");
        ...
        <tr>
          <td><div align="center"><a href="page/act_dt_gaji.php?del=oke6&idk_t=<? echo $tp['id_list_lokasi']; ?>" onClick="return konfirmasi('Yakinmi mau dihapus broo..?');"><? 
		   $tampil2=mysqli_query($koneksi, "SELECT * FROM tb_lokasi_ceklist WHERE id_ceklist='$tp[kd_lokasi]' ");
